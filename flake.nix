...
{
  description = "Nix flake for pythoneda-shared-code-requests/shared";
  inputs = rec {
    ...
    pythoneda-shared-nix-flake-shared = {
      ...
      url = "github:pythoneda-shared-nix-flake-def/shared/0.0.106";
    };
    pythoneda-shared-pythonlang-banner = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixpkgs.follows = "nixpkgs";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "shared";
        version = "0.0.9";
        sha256 = "1q55wla3m1as72xyy2xyziajbj8512c3j79i1f3mb85jxhi11kjn";
        pname = "${org}-${repo}";
        ...
        pythoneda-shared-code-requests-shared-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-shared-nix-flake-shared} ${pythoneda-shared-pythonlang-domain}; do
      ...
      in rec {
        ...
        devShells = rec {
          default = pythoneda-shared-code-requests-shared-python312;
          ...
          pythoneda-shared-code-requests-shared-python312 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-code-requests-shared-python312;
          ...
          pythoneda-shared-code-requests-shared-python313 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-code-requests-shared-python313;
